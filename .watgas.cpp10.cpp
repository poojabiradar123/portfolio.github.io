...

{
    ...
    cout << "2. Choose Material Type of Pipe\n";

    cout << "3. Choose Billing Type\n";

    cout << "4. Choose Leak Detection Type\n";

    cout << "5. Choose Supply Type\n";

    cout << "6. View Pipeline Details\n";

    cout << "7. View Customer Details\n";

    cout << "8. Finalize Selections\n";

    cout << "9. View Total Installation Cost\n";

    cout << "10. Update Maintenance Schedule\n";

    cout << "11. Add New Pipeline\n";

    cout << "12. Customer Details (Already Installed Pipeline)\n";

    cout << "13. Disconnect Pipeline (Already Installed Pipeline)\n";
...
{
    map<string, string> disconnectedCustomers;
    ...
    //cout << "Expected Lifespan: " << lifespan << " years" << endl;
     ...
     customerDatabase["C0121"] = Customer("Isabella Clark", "1202 Elm St", "C0121", "Tilakwadi", "Regular", "Monthly", 100.0, 2300.0);

    customerDatabase["C0122"] = Customer("Ethan Thomas", "1303 Cedar St", "C0122", "Udyambag", "Premium", "Monthly", 70.0, 3900.0);

    customerDatabase["C0123"] = Customer("Oliver Anderson", "1404 Pine St", "C0123", "Udyambag", "Regular", "Quarterly", 100.0, 3100.0);

    customerDatabase["C0124"] = Customer("Ava Moore", "1505 Oak St", "C0124", "Udyambag", "Premium", "Monthly", 120.0, 3800.0);

    customerDatabase["C0125"] = Customer("Lucas Harris", "1606 Birch St", "C0125", "Udyambag", "Regular", "Quarterly", 50.0, 2900.0);

    customerDatabase["C0126"] = Customer("Charlotte Lee", "1707 Willow St", "C0126", "Udyambag", "Premium", "Monthly", 90.0, 3600.0);

    customerDatabase["C0127"] = Customer("James Davis", "1808 Cherry St", "C0127", "Tilakwadi", "Regular", "Monthly", 90.0, 2800.0);
    ...
    Pipeline pipeline(500,12, "Steel", 20.5, 250, "Active", "Monthly", 0.0, "");
    ...
    while (!exitProgram) {
        ...
        cout << "\nWelcome to Belagavi Services\n";

        cout << "Please choose a service:\n";

        cout << "A. Welcome to Belagavi Water Corporation\n";

        cout << "B. Welcome to Belagavi City Gas Pipeline\n";

        cout << "C. Welcome to Belagavi City Electricity Pipeline\n";

        cout << "D. Welcome to Belagavi City Wifi Pipeline\n";
        ...
        switch (choice)
        {
            ...
            case 2:
                ...
                pipeline.material = pipeMaterial;
            ...
            case 8:
                ...
                if (billingSelected && materialSelected && leakDetectionSelected && supplyTypeSelected)
                    ...
                    customer.display();
                    pipeline.display();
                    cout << "\nThe total installation cost is: " << totalInstallCost << " currency.\n";
                }
        ...
        case 12:
        {
            ...
            if (disconnectedCustomers.find(id) != disconnectedCustomers.end()) {
        // Customer is disconnected
        cout << "Pipeline for customer ID " << id << " is disconnected. Reason: " << disconnectedCustomers[id] << endl;
          } else if (customerDatabase.find(id) != customerDatabase.end()) {
        // Customer is active
        ...
        case 13:
        {
            ...
            if (customerDatabase.find(id) != customerDatabase.end())
            {
                ...
                cin.ignore();
                getline(cin, reason);
                // Add to disconnectedCustomers map
               disconnectedCustomers[id] = reason;

               // Remove from customerDatabase
    ...
    else if (toupper(serviceChoice) == 'B') {
 ...
 // Variables for maintenance and inspection parameters
    ...
    if (integrityProgram.find("Cathodic Protection") != string::npos)
    {
        cout << "ADVICE: Ensure regular maintenance and checks of cathodic protection systems to prevent corrosion." << endl;
            ...
            cout << "Invalid service choice. Please enter A or B or C or D.\n";
        }
